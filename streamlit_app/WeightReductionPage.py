...
# Explanation of weight reduction
st.markdown(r"""
### What is Weight Reduction?

In algebraic geometry, **weight reduction** simplifies the weights that define a weighted projective space $\mathbb{P}(a_0,\dots,a_r)$ in two steps:
