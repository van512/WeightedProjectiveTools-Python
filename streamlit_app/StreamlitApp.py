...
weight_reduction_page = st.Page("WeightReductionPage.py", title="Weight Reduction", icon=":material/format_list_bulleted:")
...
pg = st.navigation([home_page, weight_reduction_page, degree_reduction_page, dimcalc_page, embedding_page, sheaf_page])
